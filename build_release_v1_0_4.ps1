...
$buildRoot = 'C:\SYNTECBuild\InvoiceManager-v1.0.4'
$distRoot = 'C:\SYNTECBuild\dist-v1.0.4'
$releaseZip = Join-Path $sourceRoot 'release\SYNTEC-InvoiceManager-v1.0.4.zip'
...
if ($version.FileVersion -notmatch '^1\.0\.4\.0') { throw 'Unexpected file version.' }
